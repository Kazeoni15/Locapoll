...
import EditPollScreen from "../components/pages/EditPollScreen";

export default function EditPoll ({ navigation , route}) {
  ...
  return (
    <SafeAreaView style={styles.droidSafeArea}>
      ...
      {/* {userUid ? <Text>{userUid}</Text>: <Text>Loading...</Text>} */}
        ...
        {userUid ? <EditPollScreen navigation={navigation} userID={userUid} route={route.params}/>: <Text>Loading...</Text>}
